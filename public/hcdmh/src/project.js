var Gvty=null,Mode = 0,ExScore = 1,detHeight = 100,Power = 0,cngPower = null;
        ...
        var a = cc._decorator
          ...
          , l = function(e) {
            ...
            t.prototype.onLoad = function() {
                null != n.Instance && n.Instance.destroy(),
                n.Instance = this,
                n.Instance.playerData = JSON.parse(cc.sys.localStorage.getItem("merging_dmh_playerData")),
                null == this.playerData && (this.playerData = new s,
                this.playerData.score = 0,
				this.playerData.isFirstPlay = 1,
                this.playerData.highScore = new Array(5),
                this.playerData.highScore[0] = 0,
                this.playerData.highScore[1] = 0,
                this.playerData.highScore[2] = 0,
                this.playerData.highScore[3] = 0,
                this.playerData.highScore[4] = 0,
                this.playerData.goldCount = 0,
                this.playerData.playCount = 0,
                this.playerData.oriskin = 0,
                n.Instance.Save())
            }
            ,
            ...
            t.prototype.GetFirstPlay = function() {
				var IFP = this.playerData.isFirstPlay;
            ...
            t.prototype.SetPlayerHighScore = function(e) {
                this.playerData.highScore[Mode] = e,
                this.Save()
            }
            ,
            t.prototype.GetPlayerHighScore = function() {
                return this.playerData.highScore[Mode]
            }
            ,
            ...
            ,
            t.prototype.SetOriskin = function() {
                this.playerData.oriskin = !this.playerData.oriskin,
                this.Save()
            }
            ,
            t.prototype.GetOriskin = function() {
                return this.playerData.oriskin;
            }
            ,
            ...
            t.prototype.Save = function() {
                cc.sys.localStorage.setItem("merging_dmh_playerData", JSON.stringify(n.Instance.playerData))
            }
            ,
            t.Instance = null,
          ...
          , f = function(e) {
            ...
            t.prototype.adsButtonFunc2 = function() {
				if (window.navigator.language == "zh-CN" || window.navigator.language == "zh-cn") {
					window.alert("本游戏由MCPlayer542 dddmh ITCarrot共同制作\n修改自 程序员鱼皮 的\"合成大西瓜\"代码");
				} else if (window.navigator.language == "zh-TW" || window.navigator.language == "zh-tw") {
					window.alert("本遊戲由MCPlayer542 dddmh ITCarrot共同製作\n修改自 程序員魚皮 的\"合成大西瓜\"代碼");
				} else if (window.navigator.language == "zh-HK" || window.navigator.language == "zh-hk") {
					window.alert("本遊戲由MCPlayer542 dddmh ITCarrot共同製作\n修改自 程序員魚皮 的\"合成大西瓜\"代碼");
				} else {
					window.alert("The game is developed by MCPlayer542 dddmh & ITCarrot\nadapted from 程序员鱼皮's code of Synthetic Watermelon");
				}
            }
            ,
            t.prototype.bannerButtonFunc = function() {
                window.location.href = "http://www.hsfz.net.cn"
            }
            ,
        ...
        var a = e("../common/PlayerInfo")
          ...
          , m = function(e) {
            ...
            t.prototype.start = function() {
				...
				if (Mode == 1)
				{
					document.getElementById("gravity_arr").style.transform="rotate(-90deg)";
					document.getElementById("gravity_arr").style.transformOrigin = "50% 50%";
					document.getElementById("gravity_arr").style.paddingRight = "0";
					document.getElementById("gravity_arr").style.left = "40%";
					document.getElementById("gravity_arr").style.opacity=1;
					document.getElementById("gravity_arr").style.top = "20%";
					Gvty=setInterval(function(){
						var x=50-Math.random()*100, y=10-Math.random()*40;
						//x=0,y=10;
						cc.director.getPhysicsManager().gravity=cc.v2(x,y);
						var deg=Math.atan(x/y)/Math.PI*180;
						document.getElementById("gravity_arr").style.transform="rotate(" + (deg+90-(y<0?180:0)) +"deg)";
						document.getElementById("gravity_arr").style.opacity=(Math.sqrt((x*x+y*y)/3400));
					},1000);
				}
				if (Mode == 2)
				{
					...
					document.getElementById("gravity_arr").style.transform="rotate(-90deg)";
					document.getElementById("gravity_arr").style.transformOrigin = "75% 50%";
					document.getElementById("gravity_arr").style.paddingRight = "20%";
					document.getElementById("gravity_arr").style.left = "20%";
					document.getElementById("gravity_arr").style.top = "1%";
				}
				/*if (cc.find("Canvas/lineNode").children[0].y - n.Instance.fruitHeigth < 300/* && this.lineNode.children[0].y - n.Instance.fruitHeigth >= 0) cc.find("Canvas/lineNode").children[0].active = 1;
					if (cc.find("Canvas/lineNode").children[0].y - n.Instance.fruitHeigth > 300) cc.find("Canvas/lineNode").children[0].active = !1;*/
                this.createOneFruit(0);//第一个水果
            }
            ,
            t.prototype.update = function(e) {
                a.default.GameUpdateCtrl,
				//if (cc.find("Canvas/lineNode").children[0].y - this.findHighestFruit() < 300 && this.lineNode.children[0].y - n.Instance.fruitHeigth >= 0) cc.find("Canvas/lineNode").children[0].active = 1;
				//if (cc.find("Canvas/lineNode").children[0].y - n.Instance.fruitHeigth > 300) cc.find("Canvas/lineNode").children[0].active = !1;
                this.lineNode.children[0].y - this.findHighestFruit() < detHeight && (this.lineNode.children[0].active = !0),
                this.lineNode.children[0].y - this.findHighestFruit() > detHeight && (this.lineNode.children[0].active = !1)
            }
			,
                ...
                if (0 == this.endOne) {
                    for (var t = 0, n = function(n) {
                        setTimeout(function() {
                            ...
                            a.default.score += e.fruitNode.children[n].getComponent("fruitData").fruitNumber + ExScore,
                            i.default.Instance.SetScoreTween(a.default.score),
            ...
            t.prototype.forceEnd = function() {
                    a.default.GameUpdateCtrl = !1;
					document.getElementById("gravity_arr").style.opacity=0;
					document.getElementById("modetext").style.opacity=0;
                ...
                if (this.lineNode.children[0].y - n.Instance.fruitHeigth < -20 && 0 == this.endOne) {
                    ...
                    for (var o = function(t) {
                        setTimeout(function() {
                            ...
                            a.default.score += e.fruitNode.children[t].getComponent("fruitData").fruitNumber + ExScore,
                            i.default.Instance.SetScoreTween(a.default.score),
            ...
            t.prototype.findHighestFruit = function() {
				if(this.fruitNode.children.length == 0) return -1200;
            ...
            t.prototype.createOneFruit = function(e) {//生成水果函数
				...
				n.getComponent(cc.RigidBody).angularDamping = 1,
            ...
            ,
            t.prototype.createLevelUpFruit = function(e, t, b, c) {
                var o = cc.instantiate(this.fruitPre);
                o.parent = this.fruitNode,
                o.getComponent("fruitData").isTarget = 0,
                ...
                o.getComponent("fruitData").endCtrl = 1,
                o.position = t,
                o.scale = 0;
				if (o.position.y < o.height / 2) o.position.y = o.height / 2;
                o.getComponent(cc.RigidBody).linearVelocity = cc.v2(b.getComponent(cc.RigidBody).linearVelocity.x+c.getComponent(cc.RigidBody).linearVelocity.x,b.getComponent(cc.RigidBody).linearVelocity.y+c.getComponent(cc.RigidBody).linearVelocity.y)
				o.getComponent(cc.RigidBody).linearDamping = (Mode == 2 ? 0.1 : 0),
				o.getComponent(cc.RigidBody).angularDamping = 1,
            ...
            t.prototype.createFruitL = function(e, t, n) {
				if(!g.default.Instance.GetOriskin() && e == 10) e = 6;
        ...
        var a = e("./GameFunction")
          ...
          , p = function(e) {
            ...
            t.prototype.onTouchStart = function(e) {
                ...
                if (Mode != 2 && i.default.playerTouch && null != a.default.Instance.targetFruit) {
				...
				if (Mode == 2 && i.default.playerTouch && null != a.default.Instance.targetFruit) {
					var x = this.node.convertToNodeSpaceAR(e.getLocation()).x,y = a.default.Instance.targetFruit.position.y+500-this.node.convertToNodeSpaceAR(e.getLocation()).y;
					document.getElementById("gravity_arr").style.opacity=(Power/3000);
					var deg=Math.atan(x/y)/Math.PI*180;
					document.getElementById("gravity_arr").style.transform="rotate(" + (-90-deg) +"deg)";
					Power = Math.random()*2500+500;
					clearInterval(cngPower);
					cngPower = setInterval(function() {
						if(Power > 3000 || Power < 500) delPower = -delPower;
						Power += delPower;
						document.getElementById("gravity_arr").style.opacity=(Power/3000);
					}, 7.5);
				}
				if(Mode != 2 && i.default.playerTouch && null != a.default.Instance.targetFruit) i.default.playerTouch && null != a.default.Instance.targetFruit && (a.default.Instance.targetFruit.x = this.node.convertToNodeSpaceAR(e.getLocation()).x);
            }
            ,
            ...
            t.prototype.onTouchEnd = function(e) {
				if(Mode == 2 && i.default.playerTouch && null != a.default.Instance.targetFruit) {
					...
					cngPower = null;
					var x = this.node.convertToNodeSpaceAR(e.getLocation()).x,y = a.default.Instance.targetFruit.position.y+500-this.node.convertToNodeSpaceAR(e.getLocation()).y;
					var deg=Math.atan(x/y);
					document.getElementById("gravity_arr").style.transform="rotate(" + (-90-deg/Math.PI*180) +"deg)";
					x=Power*Math.sin(deg);
					y=Power*Math.cos(deg);
					a.default.Instance.targetFruit.getComponent("fruitData").isTarget = 0;
					...
					a.default.Instance.targetFruit.getComponent(cc.RigidBody).linearVelocity = cc.v2(x, -y);
					a.default.Instance.targetFruit.getComponent(cc.RigidBody).linearDamping = 0.1;
					a.default.Instance.targetFruit = null;
					this.scheduleOnce(function() {
						i.default.GameUpdateCtrl && (0 == t.createFruitCount ? (a.default.Instance.createOneFruit(0),
						t.createFruitCount++) : t.createFruitCount > 0 && (a.default.Instance.createOneFruit(s.default.RandomInteger(0, 5)),
						t.createFruitCount++))
					}, .5);
				}
				if(Mode != 2 && i.default.playerTouch && null != a.default.Instance.targetFruit) {
					...
					i.default.playerTouch && null != a.default.Instance.targetFruit && (a.default.Instance.targetFruit.getComponent("fruitData").isTarget = 0,
					a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).radius = a.default.Instance.targetFruit.height / 2,
					a.default.Instance.targetFruit.getComponent(cc.PhysicsCircleCollider).apply(),
					a.default.Instance.targetFruit.getComponent(cc.RigidBody).type = cc.RigidBodyType.Dynamic,
					a.default.Instance.targetFruit.getComponent(cc.RigidBody).linearVelocity = cc.v2(0, Mode == 1 ? (-2000) : (-800)),
					a.default.Instance.targetFruit = null,
					//随机水果
					this.scheduleOnce(function() {
						i.default.GameUpdateCtrl && (Mode == 1 ? (0 == t.createFruitCount ? (a.default.Instance.createOneFruit(0),
						t.createFruitCount++) : t.createFruitCount > 0 && (a.default.Instance.createOneFruit(s.default.RandomInteger(0, 5)),
						t.createFruitCount++)) : 0 == t.createFruitCount ? (a.default.Instance.createOneFruit(0),
						...
						t.createFruitCount++) : 4 == t.createFruitCount ? (a.default.Instance.createOneFruit(3),
    ...
    MainGameJS: [function(e, t, n) {
        ...
        cc.Class({
            ...
            onLoad: function() {
				...
				if(r.default.Instance.GetFirstPlay())
				{
					if (window.navigator.language == "zh-CN" || window.navigator.language == "zh-cn") {
						window.alert("合成大马哈\n右上角设置多种模式可选\n如果卡在黑屏界面请使用其他浏览器");
					} else if (window.navigator.language == "zh-TW" || window.navigator.language == "zh-tw") {
						...
						window.alert("Merging DMH\nVarious mode avalible at settings\nPlease use other explorer if stucked in a blackscreen");
					}
				}
				if(Mode == 0 && r.default.Instance.GetOriskin())
				{
					if (window.navigator.language == "zh-CN" || window.navigator.language == "zh-cn") {
						document.getElementById("modetext").innerText="当前模式：经典游戏";
						document.getElementById("button1").src="res/zh-CN/button0.png";
					} else if (window.navigator.language == "zh-TW" || window.navigator.language == "zh-TW" || window.navigator.language == "zh-tw") {
						document.getElementById("modetext").innerText="當前模式：經典遊戲";
						document.getElementById("button1").src="res/zh-TW/button0.png";
					} else if (window.navigator.language == "zh-HK" || window.navigator.language == "zh-hk") {
						document.getElementById("modetext").innerText="當前模式：經典遊戲";
						document.getElementById("button1").src="res/zh-HK/button0.png";
					} else {
						document.getElementById("modetext").innerText="Current Mode: Classic Game";
				...
				{
					if (window.navigator.language == "zh-CN" || window.navigator.language == "zh-cn") {
						document.getElementById("modetext").innerText="当前模式：经典换皮";
					} else if (window.navigator.language == "zh-TW" || window.navigator.language == "zh-TW" || window.navigator.language == "zh-tw") {
						document.getElementById("modetext").innerText="當前模式：經典換皮";
					} else if (window.navigator.language == "zh-HK" || window.navigator.language == "zh-hk") {
						document.getElementById("modetext").innerText="當前模式：經典換皮";
					} else {
						document.getElementById("modetext").innerText="Current Mode: Reskinned Classic";
					}
				}
				if(Mode == 1)
				{
					if (window.navigator.language == "zh-CN" || window.navigator.language == "zh-cn") {
						document.getElementById("modetext").innerText="当前模式：随机重力";
					} else if (window.navigator.language == "zh-TW" || window.navigator.language == "zh-tw") {
						document.getElementById("modetext").innerText="當前模式：隨機重力";
					} else if (window.navigator.language == "zh-HK" || window.navigator.language == "zh-hk") {
						document.getElementById("modetext").innerText="當前模式：隨機重力";
					} else {
						document.getElementById("modetext").innerText="Current Mode: Random Gravity";
					}
				}
				if(Mode == 2)
				{
					if (window.navigator.language == "zh-CN" || window.navigator.language == "zh-cn") {
						document.getElementById("modetext").innerText="当前模式：刺激桌球";
					} else if (window.navigator.language == "zh-TW" || window.navigator.language == "zh-tw") {
						document.getElementById("modetext").innerText="當前模式：刺激桌球";
					} else if (window.navigator.language == "zh-HK" || window.navigator.language == "zh-hk") {
						document.getElementById("modetext").innerText="當前模式：刺激桌球";
					} else {
						document.getElementById("modetext").innerText="Current Mode: Exciting Billiards";
					}
				}
				if(Mode == 3)
				{
					if (window.navigator.language == "zh-CN" || window.navigator.language == "zh-cn") {
						document.getElementById("modetext").innerText="当前模式：层层堆砌";
					} else if (window.navigator.language == "zh-TW" || window.navigator.language == "zh-tw") {
						document.getElementById("modetext").innerText="當前模式：層層堆砌";
					} else if (window.navigator.language == "zh-HK" || window.navigator.language == "zh-hk") {
						document.getElementById("modetext").innerText="當前模式：層層堆砌";
					} else {
						document.getElementById("modetext").innerText="Current Mode: Pile the Piles";
					}
				}
				if(Mode == 4)
				{
					if (window.navigator.language == "zh-CN" || window.navigator.language == "zh-cn") {
						document.getElementById("modetext").innerText="当前模式：无尽试炼";
					} else if (window.navigator.language == "zh-TW" || window.navigator.language == "zh-tw") {
						document.getElementById("modetext").innerText="當前模式：無盡試煉";
					} else if (window.navigator.language == "zh-HK" || window.navigator.language == "zh-hk") {
						document.getElementById("modetext").innerText="當前模式：無盡試煉";
					} else {
						document.getElementById("modetext").innerText="Current Mode: Endless Challenge";
					}
				}
				document.getElementById("modetext").style.opacity=1;
            },
            play: function() {
                console.log(1);
                var e = this;
        ...
        var a = e("../common/PlayerInfo")
          ...
          , h = function(e) {
            ...
            t.prototype.adsButtonFunc = function() {
				if(a.default.playerTouch == 0) return;
				var j = 0,k;
				document.getElementById("shade").style.pointerEvents = "auto";
				k=setInterval(function() {
					if(j == 20) clearInterval(k);
					j++;
					document.getElementById("shade").style.opacity = j*2.5+"%";
					document.getElementById("button1").style.opacity = j*5+"%";
					document.getElementById("button2").style.opacity = j*5+"%";
					document.getElementById("button3").style.opacity = j*5+"%";
					document.getElementById("button4").style.opacity = j*5+"%";
					document.getElementById("button5").style.opacity = j*5+"%";
					document.getElementById("reskin").style.opacity = j*5+"%";
				},20);
				document.getElementById("button1").style.pointerEvents = "auto";
				document.getElementById("button2").style.pointerEvents = "auto";
				document.getElementById("button3").style.pointerEvents = "auto";
				document.getElementById("button4").style.pointerEvents = "auto";
				document.getElementById("button5").style.pointerEvents = "auto";
				document.getElementById("reskin").style.pointerEvents = "auto";
            }
            ,
    ...
    MainManage: [function(e, t, n) {
          ...
          , r = (e("GameUiTools"),
        {
            ...
            getHttpGameId: function() {
                ...
                this.moreGameUrl = "http://www.hsfz.net.cn"
            },
            ...
            gamePV_load: function() {
                this.ajaxLoad("gamelogo.html", "gameID=" + this.gameHttpId, this.ajaxOnLogoResult)
            },
    ...
    fruitData: [function(e, t, n) {
        ...
        var a = e("../common/PlayerInfo")
          ...
          , m = function(e) {
            ...
            t.prototype.update = function(e) {
                var t = this;
				if (this.endCtrl == 0 && this.node.y + this.node.width / 2 < cc.find("Canvas/lineNode").children[0].y) this.endCtrl=1;
                ...
                this.endCtrl && this.node.y + this.node.width / 2 > cc.find("Canvas/lineNode").children[0].y && 0 == this.endOne && this.dangerBool == 0/* && this.testEndDJS > 3 && true*/) {
					this.dangerBool = 1;
					this.dangerID=setTimeout(function() {
                    a.default.GameUpdateCtrl = !1,
                    a.default.playerTouch = !1;
					clearInterval(Gvty);
					clearInterval(cngPower);
					...
					if(Mode == 3) t.node.color = cc.Color.GREEN;
                    else t.node.color = cc.Color.RED;
				...
				if (a.default.GameUpdateCtrl == 0 || this.endCtrl && this.node.y + this.node.width / 2 < cc.find("Canvas/lineNode").children[0].y && 0 == this.endOne && this.dangerBool == 1)
				{
					this.dangerBool = 0;
					clearTimeout(this.dangerID);
				}
            }
            ,
            ...
            t.prototype.onBeginContact = function(e, t, n) {
                ...
                "fruit" == n.node.group) {
                    if (this.endCtrl = !0,
                    t.node.y < n.node.y || t.node.getComponent("fruitData").isTarget || n.node.getComponent("fruitData").isTarget)
                        return;
					t.node.getComponent("fruitData").endCtrl = 1;
					n.node.getComponent("fruitData").endCtrl = 1;
                    ...
                    0 == t.node.getComponent("fruitData").getNumber() && ((Mode == 3) ? (a.default.score -= this.fruitNumber + ExScore,a.default.score < 0 && (a.default.score = 0,i.default.Instance.end())): a.default.score += this.fruitNumber + ExScore,
                    ...
                    cc.tween(t.node).to(.1, {
                        ...
                        i.default.Instance.createLevelUpFruit(o.fruitNumber + 1, n.node.position, t, n),
						clearTimeout(t.node.getComponent("fruitData").dangerID),
						clearTimeout(n.node.getComponent("fruitData").dangerID),
                        n.node.active = !1,
                        t.node.active = !1,
                        n.node.destroy(),
                        t.node.destroy()
                    }).start())) : (9 == c || (Mode == 4 && 10 == c)) && (9 == r || (Mode == 4 && 10 == r)) && (this.pengzhuangCount += 1,
                    0 == t.node.getComponent("fruitData").getNumber() && ((Mode == 3) ? (a.default.score -= this.fruitNumber + ExScore,a.default.score < 0 && (a.default.score = 0,i.default.Instance.end())): a.default.score += (Mode == 1) ? 12 : 10,
                    u.default.Instance.SetScoreTween(a.default.score),
                    n.node.getComponent(cc.PhysicsCircleCollider).radius = 0,
                    n.node.getComponent(cc.PhysicsCircleCollider).apply(),
                    this.node.getComponent(cc.PhysicsCircleCollider).radius = 0,
                    ...
                    cc.tween(t.node).to(.1, {
                        ...
                        i.default.Instance.createFruitSui(o.fruitNumber, n.node.position),
                        i.default.Instance.createFruitL(o.fruitNumber, n.node.position, n.node.width),
                        i.default.Instance.createLevelUpFruit((n.node.getComponent("fruitData").fruitNumber == t.node.getComponent("fruitData").fruitNumber) ? 10 : 0, n.node.position, t, n);
                        ...
                        var c = new cc.Node;
                        c.addComponent(cc.Sprite).spriteFrame = l.default.Instance.fruit[(n.node.getComponent("fruitData").fruitNumber == t.node.getComponent("fruitData").fruitNumber) ? 10 : 0],//结束界面水果
                        ...
                        var s = new cc.Node,x = (n.node.getComponent("fruitData").fruitNumber == 10 || t.node.getComponent("fruitData").fruitNumber == 10);
                        s.addComponent(cc.Sprite).spriteFrame = l.default.Instance.fruit[(n.node.getComponent("fruitData").fruitNumber == t.node.getComponent("fruitData").fruitNumber) ? 10 : 0],//结束界面水果
                        s.parent = c,
                        s.position = cc.v2(0),
                        ...
                        c.runAction(cc.sequence(cc.spawn(cc.jumpBy(1, 0, 0, 300, 1), cc.scaleTo(1, 1)), cc.delayTime(1), cc.spawn(cc.moveTo(1, cc.v2(0, 500)), cc.scaleTo(1, 0)), cc.callFunc(function() {
                            if(Mode != 3) a.default.score += (Mode == 2) ? 300 : x ? 50 : 100;
							else a.default.score -= 100;
                            u.default.Instance.SetScoreTween(a.default.score),
                            e.active = !1,
                            a.default.playerTouch = !0,
                            c.destroy()
		...
		document.getElementById("shade").onclick = function()
		{
			...
			document.getElementById("button4").style.pointerEvents = "none";
			document.getElementById("button5").style.pointerEvents = "none";
			document.getElementById("reskin").style.pointerEvents = "none";
			k=setInterval(function() {
				if(j == 20) clearInterval(k);
				j++;
				document.getElementById("shade").style.opacity = 50-j*2.5+"%";
				document.getElementById("button1").style.opacity = 100-j*5+"%";
				document.getElementById("button2").style.opacity = 100-j*5+"%";
				document.getElementById("button3").style.opacity = 100-j*5+"%";
				document.getElementById("button4").style.opacity = 100-j*5+"%";
				document.getElementById("button5").style.opacity = 100-j*5+"%";
				document.getElementById("reskin").style.opacity = 100-j*5+"%";
			},20);
		}
		...
		document.getElementById("reskin").onclick = function()
		{
			g.default.Instance.SetOriskin();
			if (window.navigator.language == "zh-CN" || window.navigator.language == "zh-cn") {
				window.alert("切换材质成功\n请刷新页面以应用更改");
			} else if (window.navigator.language == "zh-TW" || window.navigator.language == "zh-tw") {
				window.alert("切換材質成功\n請刷新頁面以應用更改");
				...
				window.alert("Resource changed successfully\nPlease refresh the page to apply changes");
			}
		}
        n.default = m,
        cc._RF.pop()
